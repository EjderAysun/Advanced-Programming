...
int main() {
    ...
    */
    ...
    // When you put an integer and a floating point in an expression, \
    ...
    Therefore, it may be more efficient to use the float data type, \
    especially when performing large numerical calculations.
